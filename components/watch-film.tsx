  ...
  return (
    ...
    >
      ...
      <div className="relative grid items-center gap-10 md:grid-cols-[1fr_auto] md:gap-16">
        <div>
          <p className="eyebrow text-primary-foreground/70">Watch</p>
          ...
          <p className="mt-8 flex items-center gap-3 font-mono text-xs uppercase tracking-[0.2em] text-primary-foreground/70">
            <Play className="size-4 text-accent-ink" /> 2:58 / Kampala
          </p>
        </div>
